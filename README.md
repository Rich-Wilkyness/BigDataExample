...
The [interactive lab learner guide](notebooks/interactive-data-engineering-labs/README.md) lists the available labs, explains how implementation files relate to notebooks and checks, and documents how to run, restart, or reset an attempt. Solutions remain separate under [`docs/interactive-data-engineering-labs/solutions/`](docs/interactive-data-engineering-labs/solutions/), while source intake and lab-authoring plans remain under [`docs/interactive-data-engineering-labs/`](docs/interactive-data-engineering-labs/README.md).
