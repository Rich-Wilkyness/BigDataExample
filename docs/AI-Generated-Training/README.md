...
| 09 Apache Spark and Distributed Computation | Spark architecture, DataFrames/SQL, lazy plans, jobs/stages/tasks, partitions, joins, memory, UDFs, tuning, testing, and deployment | Documentation complete; local PySpark environment smoke-tested; topic and distributed evidence planned |
