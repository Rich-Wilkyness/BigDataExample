...
if [[ "${1:-}" != "--force" ]]; then
    echo "This removes only OP-C02 containers, network, named volume, .env, and generated report."
...
echo "OP-C02 generated state removed. Learner Python was preserved."
